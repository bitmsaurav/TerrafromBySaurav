...
**Learn Terraform Input Variables with Validation Rules**
...
substr("Saurav kunal", 1, 4)
substr("Saurav kunal", 0, 6)
substr("Saurav kunal", 0, 1)
substr("Saurav kunal", 0, 0)
substr("Saurav kunal", 0, 10)
