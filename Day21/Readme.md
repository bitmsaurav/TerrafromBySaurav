...
1.  terraform-remote-state-datasource.tf
2.  versions.tf
3.  variables.tf
4.  locals.tf
5.  linux-virtual-machine.tf
6.  outputs.tf
7.  terraform.tfvars

## Step-05: Project-2: terraform-remote-state-datasource.tf
...
## Step-06: Project-2: linux-virtual-machine.tf
