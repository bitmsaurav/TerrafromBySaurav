...
## Step-05: vritual-network.tf - Virtual Network Resource
...
## Step-06: vritual-network.tf - Azure Subnet Resource
...
## Step-07: vritual-network.tf - Azure Public IP Resource
...
## Step-08: vritual-network.tf - Network Interface Resource
...
## Step-09: linux-virtual-machine.tf
...
write_files:
  - owner: root:root 
    ...
    content: |
      <h1>Welcome to SauravkunalTech - APP-1</h1>
  - owner: root:root 
    path: /var/www/html/app1/index.html
    content: |
      <!DOCTYPE html> <html> <body style="background-color:rgb(250, 210, 210);"> <h1>Welcome to SauravkunalTech - APP-1</h1> <p>Terraform Demo</p> <p>Application Version: V1</p> </body></html>      
runcmd:
...
# Go Azure portal and add the inbound rule for the virtual machine
   go to vm->networking->inbound rule
# Access Application
http://<PUBLIC_IP>
http://<PUBLIC_IP>/app1
