...
-   As part of that we have added two more variables in  `variables.tf`  for this demo
...
# Uncomment and Comment right values in variables.tf (Roll back to put ready for student demo)
